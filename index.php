...
$faqs = [
    ...
    [
        ...
        "answer" => "<p>l tuo account è associato a un paese (o territorio) nei Termini di servizio per poter stabilire due cose:</p>
        <ol>
            <li>
                ...
                <ul>
                    <li>
                        <p><span>a.</span> Google Ireland Limited, se gli utenti sono residenti nello Spazio economico europeo (paesi dell'Unione europea, oltre a Islanda, Liechtenstein e Norvegia) o in Svizzera.</p>
                    </li>
                    <li>
                        <p><span>b.</span> Google LLC, con sede negli Stati Uniti, per il resto del mondo.</p>
                    </li>
                </ul>    
            </li>
